...
INSERT INTO NEWSANDUPDATES (NEWS_ID, DESCRIPTION, HEADLINE)
VALUES (1200, 'The Barbie movie has grossed over $1 billion worldwide.', 'Barbie Movie Reaches $1 Billion Milestone');

INSERT INTO NEWSANDUPDATES (NEWS_ID, DESCRIPTION, HEADLINE)
VALUES (1201, 'Naruto Shippuden announces new episodes to celebrate the 20th anniversary.', 'Naruto Shippuden 20th Anniversary Specials');

INSERT INTO NEWSANDUPDATES (NEWS_ID, DESCRIPTION, HEADLINE)
VALUES (1202, 'The Last of Us season 2 is currently in production.', 'The Last of Us Season 2: Production Updates');

INSERT INTO NEWSANDUPDATES (NEWS_ID, DESCRIPTION, HEADLINE)
VALUES (1203, 'Attack on Titan Final Season Part 4 trailer is now out.', 'Attack on Titan Final Season Part 4 Trailer Released');

INSERT INTO NEWSANDUPDATES (NEWS_ID, DESCRIPTION, HEADLINE)
VALUES (1204, 'The Bear season 3 renewal officially confirmed.', 'The Bear Season 3 Renewal Confirmed');

INSERT INTO NEWSANDUPDATES (NEWS_ID, DESCRIPTION, HEADLINE)
VALUES (1205, 'The Office celebrates its 20th anniversary with a special reunion.', 'The Office 20th Anniversary Reunion Announced');

INSERT INTO NEWSANDUPDATES (NEWS_ID, DESCRIPTION, HEADLINE)
VALUES (1206, 'Tokyo Ghoul creator announces a new manga project.', 'New Manga Project by Tokyo Ghoul Creator');

INSERT INTO NEWSANDUPDATES (NEWS_ID, DESCRIPTION, HEADLINE)
VALUES (1207, 'Stranger Things season 5 will be its final season.', 'Stranger Things Season 5: The End of an Era');

INSERT INTO NEWSANDUPDATES (NEWS_ID, DESCRIPTION, HEADLINE)
VALUES (1208, 'Heavenly Delusion anime adaptation to premiere next spring.', 'Heavenly Delusion Anime Set for Spring 2024');

INSERT INTO NEWSANDUPDATES (NEWS_ID, DESCRIPTION, HEADLINE)
VALUES (1209, 'Vinland Saga season 3 announced with new key visual.', 'Vinland Saga Season 3 Announcement and Key Visual Released');

INSERT INTO NEWSANDUPDATES (NEWS_ID, DESCRIPTION, HEADLINE)
VALUES (1210, 'Death Note live-action series gets a new teaser from Netflix.', 'Death Note Netflix Live-Action Teaser Released');


INSERT INTO NEWSTOMEDIA (MEDIA_ID, NEWS_ID, NEWS_DATE)
VALUES (12, 1200, TO_DATE('01-SEP-2024', 'DD-MON-YYYY'));

INSERT INTO NEWSTOMEDIA (MEDIA_ID, NEWS_ID, NEWS_DATE)
VALUES (28, 1201, TO_DATE('05-SEP-2024', 'DD-MON-YYYY'));

INSERT INTO NEWSTOMEDIA (MEDIA_ID, NEWS_ID, NEWS_DATE)
VALUES (78, 1202, TO_DATE('10-SEP-2024', 'DD-MON-YYYY'));

INSERT INTO NEWSTOMEDIA (MEDIA_ID, NEWS_ID, NEWS_DATE)
VALUES (29, 1203, TO_DATE('15-SEP-2024', 'DD-MON-YYYY'));

INSERT INTO NEWSTOMEDIA (MEDIA_ID, NEWS_ID, NEWS_DATE)
VALUES (82, 1204, TO_DATE('20-SEP-2024', 'DD-MON-YYYY'));

INSERT INTO NEWSTOMEDIA (MEDIA_ID, NEWS_ID, NEWS_DATE)
VALUES (83, 1205, TO_DATE('25-SEP-2024', 'DD-MON-YYYY'));

INSERT INTO NEWSTOMEDIA (MEDIA_ID, NEWS_ID, NEWS_DATE)
VALUES (33, 1206, TO_DATE('30-SEP-2024', 'DD-MON-YYYY'));

INSERT INTO NEWSTOMEDIA (MEDIA_ID, NEWS_ID, NEWS_DATE)
VALUES (88, 1207, TO_DATE('05-OCT-2024', 'DD-MON-YYYY'));

INSERT INTO NEWSTOMEDIA (MEDIA_ID, NEWS_ID, NEWS_DATE)
VALUES (35, 1208, TO_DATE('10-OCT-2024', 'DD-MON-YYYY'));

INSERT INTO NEWSTOMEDIA (MEDIA_ID, NEWS_ID, NEWS_DATE)
VALUES (39, 1209, TO_DATE('15-OCT-2024', 'DD-MON-YYYY'));

INSERT INTO NEWSTOMEDIA (MEDIA_ID, NEWS_ID, NEWS_DATE)
VALUES (40, 1210, TO_DATE('20-OCT-2024', 'DD-MON-YYYY'));
