  ...
  const handleSubmit = async (event) => {
    ...
    try {
      const response = await fetch(
        `http://localhost:5000/login/${selectedUserType}`,
        {
          method: "POST",
          headers: {
    ...
    <div className="login-background">
      ...
      <div className="login-container">
        <div className="login-container-left">
          <p className="login-title">Welcome to</p>
          <img className="login-logo" alt="MediaVerse Logo" src={logo} />
          <h1 className="login-title1">
           Explore, List, and Discuss: Your Gateway to MediaVerse
          </h1>
        </div>
          ...
          <form onSubmit={handleSubmit} className="login-form">
            ...
            <div className="form-group-login">
              <FormControl fullWidth variant="outlined" sx={{ minWidth: 120 }}>
                <InputLabel id="user-type-label" sx={{ color: "#ccc" }}>
                  User Type
                </InputLabel>
                <Select
