...
const MovieList = ({ movies, title }) => {
  ...
  const displayText =
    title === "Top Picks for You"
      ...
      : title === "Romance"
      ? "Want some love in life? Then check out these Romantic movies! then cry alone in the corner of your room."
      : title === "Action"
      ...
      : "Discover the songs that are setting the charts on fire!";
